...
import { ChevronLeft, MessageSquare, Send, Lightbulb, HelpCircle } from "lucide-react";
          ...
          <>
            ...
            {messages.length === 1 && (
              <div className="px-4 py-3 space-y-2 border-t border-border/30 bg-muted/10">
                ...
                <button
                  onClick={() => handleQuickQuestion("Why is order ORD-001 in Rake R1?")}
            ...
            {/* Input */}
            <form onSubmit={handleSendMessage} className="border-t border-border/30 p-3 space-y-2 bg-muted/5">
              <input
                type="text"
                value={message}
